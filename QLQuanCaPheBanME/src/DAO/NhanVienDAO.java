...
public class NhanVienDAO implements InterfaceNhanVien {
    ...
    String UPDATE_SQL = "UPDATE NhanVien set TenNV = ?,Gender = ?,Ngaysinh = ?,Diachi = ?,Email = ?,SDT=?,Vaitro = ?,Trangthai = ?,Hinh = ? where ID_Nhanvien = ?";
    ...
    public void update(NhanVien Entity) {
        jdbcHelper.update(UPDATE_SQL, Entity.getTenNV(), Entity.isGender(), Entity.getNgaysinh(), Entity.getDiaChi(), Entity.getEmail(),
                Entity.getSDT(), Entity.isVaiTro(), Entity.isTrangThai(), Entity.getHinh(), Entity.getId_Nhanvien());
    }
