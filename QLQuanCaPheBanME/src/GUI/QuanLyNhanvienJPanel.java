...
public class QuanLyNhanvienJPanel extends javax.swing.JPanel {
    ...
    BUL.SerNhanVien inserts = new SerNhanVien();
    BUL.SerNhanVien updates = new SerNhanVien();
    BUL.SerNhanVien deletes = new SerNhanVien();
...
//        }
    ...
    public NhanVien getForm() {
        ...
        return nv;
    }//thằng date chỉ lên check không đúng định dạng vì bỏ trống và nhập sai nó chỉ quy viề 1
//    public Date getDate(String ns) {
//        try {
//            Date date = (Date) format.parse(ns);
//            return date;
...
//    }
    ...
    private boolean checkSDT() {
        try {
            int dth = Integer.parseInt(txtSDT.getText());
            if (txtSDT.getText().length() < 0 || txtSDT.getText().length() > 12) {
                JOptionPane.showMessageDialog(this, "Số điện thoại phải lớn hơn 0 và nhỏ hơn 12");
                return false;
            } else {
                return true;
            }
    ...
    private boolean checkLength() {
        if (txtMaNV.getText().length() < 5) {
            JOptionPane.showMessageDialog(this, "Mã nhân viên phải từ 5 ký tự trở lên");
            return false;
        }
        ...
        if (txtTenNV.getText().length() < 10) {
            JOptionPane.showMessageDialog(this, "Tên nhân viên phải tối đa 10 ký tự");
            return false;
        }
        return true;
    }
